...
Signal conditioning for ADC and DAC is provided, as per the CS4272 reference design. Further conditioning is required offboard depending on what your input signal is, and what your sending your output signal to (for example, to condition the inputs for guitar signals vs. line level signals).
